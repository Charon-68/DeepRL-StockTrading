...
def main():
    ...
    # 3. Train SAC
    # ------------------------------------------------------------------
    print("\n[3/3] Initialising SAC agent...")

    agent = SACAgent(env=train_env, run_name="sac_run_1")

    agent.train(total_timesteps=SAC_TOTAL_TIMESTEPS)

    agent.save()

    print("\n" + "=" * 60)
    print("DONE — view SAC curves alongside PPO in tensorboard:")
    print("  tensorboard --logdir results/logs --port 6007")
    print("=" * 60)
